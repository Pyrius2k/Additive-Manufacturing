...
//#define HOTEND_OFFSET_X { 0.0, 115 } // (mm) relative X-offset for each nozzle
//#define HOTEND_OFFSET_Y { 0.0, 10 }  // (mm) relative Y-offset for each nozzle
...
#define X_BED_SIZE 885
#define Y_BED_SIZE 1530
